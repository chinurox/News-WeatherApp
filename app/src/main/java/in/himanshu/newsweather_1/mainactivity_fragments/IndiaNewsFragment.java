 ...
 */
public class IndiaNewsFragment extends Fragment implements CollapsingToolbarInterface{
    RecyclerView recyclerView;
    TopNewsRecyclerViewAdapter indiaNewsRecyclerViewAdapter;
    ArrayList<News> news;
    View fragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView= inflater.inflate(R.layout.fragment_india_news,container,false);

        recyclerView= (RecyclerView) fragmentView.findViewById(R.id.sportsNewsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        news= new ArrayList<>();
        indiaNewsRecyclerViewAdapter= new TopNewsRecyclerViewAdapter(getActivity(),news,getActivity().getAssets(),"Indian News");
        recyclerView.setAdapter(indiaNewsRecyclerViewAdapter);
    ...
    private void getNews() {
        ...
        Call<MashapeResponse> call= service.getIndiaNews("J7AdboyBubmshpah8ihTxZZl4aKQp1teQBOjsnCbfz3CcwcEEQ","application/json");
        call.enqueue(new Callback<MashapeResponse>() {
            ...
            public void onResponse(Call<MashapeResponse> call, Response<MashapeResponse> response) {
                ...
                indiaNewsRecyclerViewAdapter.notifyDataSetChanged();
