...
public class BusinessNewsFragment extends Fragment implements CollapsingToolbarInterface{
    RecyclerView recyclerView;
    TopNewsRecyclerViewAdapter businessNewsRecyclerViewAdapter;
    ArrayList<News> news;
    View fragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView= inflater.inflate(R.layout.fragment_business_news,container,false);

        recyclerView= (RecyclerView) fragmentView.findViewById(R.id.sportsNewsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        news= new ArrayList<>();
        businessNewsRecyclerViewAdapter= new TopNewsRecyclerViewAdapter(getActivity(),news,getActivity().getAssets(),"Business News");
        recyclerView.setAdapter(businessNewsRecyclerViewAdapter);
    ...
    private void getNews() {
        ...
        Call<MashapeResponse> call= service.getBusinessNews("J7AdboyBubmshpah8ihTxZZl4aKQp1teQBOjsnCbfz3CcwcEEQ","application/json");
        call.enqueue(new Callback<MashapeResponse>() {
            ...
            public void onResponse(Call<MashapeResponse> call, Response<MashapeResponse> response) {
                ...
                businessNewsRecyclerViewAdapter.notifyDataSetChanged();
