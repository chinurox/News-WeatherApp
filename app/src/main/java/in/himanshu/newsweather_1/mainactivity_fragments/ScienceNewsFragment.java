 ...
 */
public class ScienceNewsFragment extends Fragment implements CollapsingToolbarInterface{
    RecyclerView recyclerView;
    TopNewsRecyclerViewAdapter scienceNewsRecyclerViewAdapter;
    ArrayList<News> news;
    View fragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView= inflater.inflate(R.layout.fragment_science_news,container,false);

        recyclerView= (RecyclerView) fragmentView.findViewById(R.id.sportsNewsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        news= new ArrayList<>();
        scienceNewsRecyclerViewAdapter= new TopNewsRecyclerViewAdapter(getActivity(),news,getActivity().getAssets(),"Science News");
        recyclerView.setAdapter(scienceNewsRecyclerViewAdapter);
    ...
    private void getNews() {
        ...
        Call<MashapeResponse> call= service.getScienceNews("J7AdboyBubmshpah8ihTxZZl4aKQp1teQBOjsnCbfz3CcwcEEQ","application/json");
        call.enqueue(new Callback<MashapeResponse>() {
            ...
            public void onResponse(Call<MashapeResponse> call, Response<MashapeResponse> response) {
                ...
                scienceNewsRecyclerViewAdapter.notifyDataSetChanged();
