 ...
 */
public class TechNewsFragment extends Fragment implements CollapsingToolbarInterface{
    RecyclerView recyclerView;
    TopNewsRecyclerViewAdapter techNewsRecyclerViewAdapter;
    ArrayList<News> news;
    View fragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView= inflater.inflate(R.layout.fragment_tech_news,container,false);

        recyclerView= (RecyclerView) fragmentView.findViewById(R.id.sportsNewsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        news= new ArrayList<>();
        techNewsRecyclerViewAdapter= new TopNewsRecyclerViewAdapter(getActivity(),news,getActivity().getAssets(),"Tech News");
        recyclerView.setAdapter(techNewsRecyclerViewAdapter);
    ...
    private void getNews() {
        ...
        Call<MashapeResponse> call= service.getTechNews("J7AdboyBubmshpah8ihTxZZl4aKQp1teQBOjsnCbfz3CcwcEEQ","application/json");
        call.enqueue(new Callback<MashapeResponse>() {
            ...
            public void onResponse(Call<MashapeResponse> call, Response<MashapeResponse> response) {
                ...
                techNewsRecyclerViewAdapter.notifyDataSetChanged();
