 ...
 */
public class EntertainmentNewsFragment extends Fragment implements CollapsingToolbarInterface{
    RecyclerView recyclerView;
    TopNewsRecyclerViewAdapter entertainmentNewsRecyclerViewAdapter;
    ArrayList<News> news;
    View fragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentView= inflater.inflate(R.layout.fragment_entertainment_news,container,false);

        recyclerView= (RecyclerView) fragmentView.findViewById(R.id.sportsNewsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        news= new ArrayList<>();
        entertainmentNewsRecyclerViewAdapter= new TopNewsRecyclerViewAdapter(getActivity(),news,getActivity().getAssets(),"Entertainment News");
        recyclerView.setAdapter(entertainmentNewsRecyclerViewAdapter);
    ...
    private void getNews() {
        ...
        Call<MashapeResponse> call= service.getEntertainmentNews("J7AdboyBubmshpah8ihTxZZl4aKQp1teQBOjsnCbfz3CcwcEEQ","application/json");
        call.enqueue(new Callback<MashapeResponse>() {
            ...
            public void onResponse(Call<MashapeResponse> call, Response<MashapeResponse> response) {
                ...
                entertainmentNewsRecyclerViewAdapter.notifyDataSetChanged();
